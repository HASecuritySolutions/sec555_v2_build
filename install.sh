...
alias wikiup="docker run -it --rm --net=bridge --network=labs_esnet -v /root/.ssh:/root/.ssh:ro -v /home/student/.ssh:/home/student/.ssh:ro -v /labs:/labs -v /var/www/sec555-wiki:/var/www/sec555-wiki -v /scripts:/scripts -v /var/run/docker.sock:/var/run/docker.sock hasecuritysolutions/wikiup:v1.0"
