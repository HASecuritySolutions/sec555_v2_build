...
alias logstash="docker run -it --rm --net=bridge --name logstash --hostname logstash -v /labs:/labs --link elasticsearch --link freq_server --link domain_stats -e ELASTICSEARCH_HOST=elasticsearch -p 5044:5044 -p 5045:5045 -p 6000:6000 -p 6050:6050 hasecuritysolutions/logstashoss:v6.2.2 /usr/share/logstash/bin/logstash"
